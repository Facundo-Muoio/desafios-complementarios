...
function guardarDatos(e){
    e.preventDefault()
    let producto = {Nombre:document.getElementById("productName").value, Id:document.getElementById("productId").value, Clase:document.getElementById("productClass").value, Precio:document.getElementById("productPrice").value}
    productos.push(producto);
    localStorage.setItem("Listado de productos",JSON.stringify(productos))
    let divCards = document.createElement("div");
    divCards.innerHTML = `<div class="div__card"><p class="div__card--p">Nombre: ${document.getElementById("productName").value}</p><br>
    <p class="div__card--p">ID: ${document.getElementById("productId").value}</p><br>
    <p class="div__card--p">Clase: ${document.getElementById("productClass").value}</p><br>
    <p class="div__card--p">Precio: ${document.getElementById("productPrice").value}</p></div>`
    document.body.appendChild(divCards)
}   

const productos = []
let save = document.getElementById("btnGuardar");
save.addEventListener("click",guardarDatos);
